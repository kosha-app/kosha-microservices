...
class MusicControllerTest {
    ...
    fun `test createAlbum endpoint`(){
        val album = AlbumModel("album-id","","AlbumName","AlbumArtist","","", listOf(TrackModel("trackId", "TrackName", "ArtistName", "trackUrl")))
    ...
    fun `test searchAlbum endpoint`(){
        ...
        val album = AlbumModel2("album-id","","AlbumName","AlbumArtist","","", listOf(TrackModel2("trackId", "TrackName", "ArtistName", "trackUrl", "")))
    ...
    fun `test searchATrack endpoint`(){
        val query = "ArtistName"
        val track = TrackModel2("trackId", "TrackName", "ArtistName", "trackUrl", "")
